...
<div class="dashboard-cards">
    <div class="dashboard-card overdue">
        ...
        <a href="request_list.asp?filter=overdue" class="btn btn-sm btn-danger">一覧を見る</a>
    </div>
    <div class="dashboard-card soon">
        <div class="count"><%= countSoon %></div>
        <div class="label">期限間近（<%= REMIND_DAYS_BEFORE %>日以内）</div>
        <a href="request_list.asp?filter=soon" class="btn btn-sm btn-warning">一覧を見る</a>
    </div>
    <div class="dashboard-card in-progress">
        <div class="count"><%= countInProgress %></div>
        <div class="label">着手済</div>
        <a href="request_list.asp?filter=in_progress" class="btn btn-sm btn-primary">一覧を見る</a>
    </div>
    <div class="dashboard-card">
        <div class="count"><%= countTotal %></div>
        <div class="label">全依頼件数</div>
        <a href="request_list.asp" class="btn btn-sm btn-secondary">一覧を見る</a>
    </div>
</div>
